<script>
    import Img from "$lib/images/stones/IMG_4789.jpeg"
</script>

<div class="mx-auto">
    <div class="flex flex-col gap-10">
        <p class="mx-auto text-center font-bold">
        ...
        <p>
            ...
            vil jeg veldig gjerne høre fra deg.
        </p>
        <p>
            Send meg gjerne en mail dersom du vet noe!
        </p>
        <div>
            <p>Knut Einar Skår</p>
            <a class="text-blue-600 underline" 
                href="mailto:knut.einar.skaar@gmail.com">knut.einar.skaar@gmail.com</a>
        </div>
    </div>
</div>